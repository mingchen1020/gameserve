...
gdjs.GAME_32OVERCode.asyncCallback19098932 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.75), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19098932(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GAME_32OVERCode.asyncCallback19100748 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
gdjs.copyArray(asyncObjectsList.getObjects("BACK"), gdjs.GAME_32OVERCode.GDBACKObjects2);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
for (const obj of gdjs.GAME_32OVERCode.GDBACKObjects1) asyncObjectsList.addObject("BACK", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.75), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19100748(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GAME_32OVERCode.asyncCallback19102980 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19102980(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GAME_32OVERCode.asyncCallback19104276 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "GAME START", false);
}gdjs.GAME_32OVERCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19104276(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GAME_32OVERCode.asyncCallback19105508 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "GAME START", false);
}gdjs.GAME_32OVERCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19105508(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GAME_32OVERCode.asyncCallback19106636 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "GAME START", false);
}gdjs.GAME_32OVERCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GAME_32OVERCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.GAME_32OVERCode.asyncCallback19106636(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19103804);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "按鍵.mp3", false, 100, 1);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19106268);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "按鍵.mp3", false, 100, 1);
